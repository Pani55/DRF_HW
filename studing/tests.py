...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(title="ajajaja", link="http//youtube.com",
    ...
    def test_lesson_create(self):
        ...
        data1 = {"title": "test_lesson", "link": "http://youtube.com", "course": self.course.pk}
        response1 = self.client.post(url, data1)
        self.assertEqual(response1.status_code, status.HTTP_201_CREATED)
        self.assertEqual(Lesson.objects.count(), 2)
        data2 = {"title": "test_bad_link", "link": "http://violenty.ru", "course": self.course.pk}
